...
const FootERComponent = () => {
	...
	const contactLinks = [
		{
			title: "(+251)-904-050-906",
			link: "tel:+112345678",
		},
		{
			title: "help@ERC.com",
			link: "mailto:help@ERC.com",
		},
		{
			title: "AdissAbeba, Ethiopia",
			...
			<div className="two-cta-container relative w-[min(100%_-_15px,1250px)]  mx-auto my-0 p-2.5">
				<div className="first-section-wrapper grid sm:grid-cols-[1.5fr_1fr_1fr] gap-10">
					<div className="flex flex-col footer-col first-col">
						<h2 className="not-italic font-bold text-[30px] leading-[55px] text-white">
							ETHIOPIAN <span className="text-[red] mx-2">RED CROSS</span>
							ASSOCIATION
						</h2>
