...
import BlackLogo from "../../../assets/images/image.png";
...
// const logoUrl = "../public/ERC Logo black.png";
// const logoUrlWhite = "../public/ERC Logo White.png";
const compnayName = "Ethiopian Red Cross";
...
const HeadERComponent = () => {
	...
	return (
		...
		>
			...
			>
				{/* Logo */}
				<div className="flex lg:flex-1 flex-row items-center justify-start w-[100px]">
					<a href="/" className="-m-1.5 p-1.5">
						<span className="sr-only">{compnayName}</span>
						<img className="w-[70px] h-[70px] rounded-full " src={logo} alt="" />
					</a>
					<p className="text-white font-bold text-[18px] w-[200px] mx-4">Ethiopian Red Cross Association</p>
				</div>
